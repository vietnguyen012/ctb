...
def main():
    ...
    subparser.add_argument("--model-path-base",default="models/English_bert_base_uncased")
    subparser.add_argument("--evalb-dir", default="EVALB/")
    subparser.add_argument("--train-path", default="data/train_tree")
    subparser.add_argument("--train-path-text", type=str)
    subparser.add_argument("--dev-path", default="data/dev_tree")
    ...
    # subparser.add_argument("--model-path",default="")
    # subparser.add_argument("--evalb-dir", default="EVALB/")
